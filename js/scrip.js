...
fetch("http://localhost:3000/listar")
  ...
  .catch((erro) => console.log(`Erro ao tentar ler a API ${erro}`));

// Código para cadastrar os dados do formulário
function cadastrar() {
  ...
  fetch("http://localhost:3000/cadastrar", {
    method: "POST", //vai ser a mesma estrutura
    headers: {
...
// Código para atualizar os dados do formulário
function atualizar() {
  ...
  fetch("http://localhost:3000/atualizar", {
    method: "PUT", //vai ser a mesma estrutura
    headers: {
      accept: "application/json",
      "Content-Type": "application/json",
    },
...
// Código para apagar os dados dos produtos
function apagar() {
  var idproduto = document.getElementById("idproduto");

  fetch("http://localhost:3000/apagar", {
    method: "DELETE", //vai ser a mesma estrutura
    headers: {
      accept: "application/json",
      "Content-Type": "application/json",
    },
